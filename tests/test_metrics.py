...
def test_era_5_met_preprocess_umep():
    ...
    indicator = Era5MetPreprocessingUmep(start_date='2023-01-01', end_date='2023-12-31').get_metric(USA_OR_PORTLAND_ZONE)
...
def test_era_5_met_preprocess_upenn():
    # Useful site: https://projects.oregonlive.com/weather/temps/
    indicator = Era5MetPreprocessingUPenn(start_date='2023-01-01', end_date='2023-12-31').get_metric(USA_OR_PORTLAND_ZONE)
