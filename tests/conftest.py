...
BUENOS_AIRES_WGS84 = GeoExtent(bbox=(-58.89079284843553, -35.009468078762055, -58.01673109153538, -34.001892090572426), crs='EPSG:4326')
BUENOS_AIRES_ZONES_TINY = GeoZone(create_fishnet_gdf_for_testing(BUENOS_AIRES_WGS84.coords, 0.02).reset_index().iloc[[1,2,3]])
BUENOS_AIRES_BBOX_TINY = GeoExtent(BUENOS_AIRES_ZONES_TINY)
