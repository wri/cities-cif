...
def test_custom_name_for_layer_with_one_custom_minor_param():
    ...
    assert is_custom_layer == True
    assert layer_id == 'AqueductFlood__ReturnPeriodC_rp0002__Year_2050.tif'
...
def test_custom_name_for_layer_with_two_custom_minor_param():
    ...
    assert is_custom_layer == True
    assert layer_id == 'AqueductFlood__ReturnPeriodC_rp0002__ReturnPeriodR_rp00002__Year_2050.tif'
