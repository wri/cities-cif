...
class WhoExceedanceDays(Cams):
    ...
    def get_data(self, bbox: GeoExtent, spatial_resolution=None, resampling_method=None):
        ...
        if not self.species:
            self.species = [CamsSpecies.CO, CamsSpecies.NO2, CamsSpecies.O3, CamsSpecies.SO2, CamsSpecies.PM25, CamsSpecies.PM10]
        
        excdays = []
        for s in self.species:
            if s == CamsSpecies.O3:
                n = 8
                ds = cams.sel(variable=SPECIES_INFO['o3']['eac4_varname'])
                ...
                ds = cams.sel(variable=SPECIES_INFO[s]['eac4_varname'])
