...
class Era5MetPreprocessingUPenn(Metric):
    ...
    def get_metric(self,
        ...
        t2m_var = era_5_data.sel(variable='temperature_2m').values
        d2m_var = era_5_data.sel(variable='dewpoint_temperature_2m').values
        u10_var = era_5_data.sel(variable='u_component_of_wind_10m').values
        v10_var = era_5_data.sel(variable='v_component_of_wind_10m').values
        sp_var = era_5_data.sel(variable='surface_pressure').values
        ssrd_var = era_5_data.sel(variable='surface_solar_radiation_downwards').values
        fdir_var = era_5_data.sel(variable='total_sky_direct_solar_radiation_at_surface').values
        ...
        dhi_vals = ghi_vals - dni_vals * cos_z.flatten()
        clear_sky_dhi_vals = clear_sky_ghi_vals - clear_sky_dni_vals * cos_z.flatten()
