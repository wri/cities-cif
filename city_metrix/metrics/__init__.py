...
from .percent_key_biodiversity_area_not_built_up import PercentKeyBiodiversityAreaNotBuiltUp
from .percent_key_biodiversity_area_protected import PercentKeyBiodiversityAreaProtected
