...
class NaturalAreas(Layer):
    ...
    def get_data(self, bbox: GeoExtent, spatial_resolution:int=DEFAULT_SPATIAL_RESOLUTION,
        ...
        esa_world_cover = EsaWorldCover().retrieve_data(bbox=bbox, s3_bucket=CIF_CACHE_S3_BUCKET_URI, s3_env=DEFAULT_PRODUCTION_ENV, spatial_resolution=spatial_resolution)
        reclass_map = {
