...
class SpeciesObservations(Layer):
    ...
    def get_data(self, bbox: GeoExtent, spatial_resolution=None, resampling_method=None,
        ...
        #     ]
            ...
            #     ]
            # )
        all_observations = gpd.GeoDataFrame.from_file(f'{GBIF_PATH}/{self.city_id}__{self.geo_level}__{self.taxon.value["taxon"]}__{self.start_year}-{self.end_year}.geojson')
