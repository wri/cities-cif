...
from city_metrix.constants import cif_production_aws_bucket_uri, cif_testing_s3_bucket_uri
...
def set_cache_settings(uri, env):
    ...
    cif_cache_settings.aws_bucket = cif_production_aws_bucket_uri if env == 'dev' else cif_testing_s3_bucket_uri
